  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="container mx-auto px-4 space-y-8">
        <div>
        <h2 className="text-2xl font-bold">Welcome to Studic</h2>
        <p className="mt-4">
        ...
        <p className="mt-2">
          All content on Studic is owned by Siddharth Sharma. Unauthorized use of the material may result in legal action.
        </p>
